...
class Encoder:
    ...
    Ported and adjusted to RPi.GPIO from the pigpio sample here:
    http://abyz.co.uk/rpi/pigpio/examples.html
    Original code from https://gist.github.com/savetheclocktower/9b5f67c20f6c04e65ed88f2e594d43c1 by Andrew Dupont
    """
    ...
    def __init__(self, gpioA, gpioB, callback=None, buttonPin=None, buttonCallback=None):
        ...
        if self.gpioButton:
            ...
            GPIO.add_event_detect(self.gpioButton, GPIO.FALLING, self._buttonCallback, bouncetime=250)
